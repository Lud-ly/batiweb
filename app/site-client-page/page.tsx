...
import { projectsCardSiteClient } from "~/data/siteclient";
import ArrowBack from "~/src/components/ArrowBack";
import SiteClientLinks from "~/src/components/Projects/SiteclientLinks";

export default function SiteClientPage() {
  ...
  return (
    <div className="flex flex-col p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center my-9">
        {projectsCardSiteClient.map((projectsCard) => (
